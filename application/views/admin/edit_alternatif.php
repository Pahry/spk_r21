    ...
    <div id="content-wrapper">
      <div class="container-fluid">
		...
		<div class="form-group">  
          ...
          <button type="simpan" class="btn btn-success"><span class="glyphicon glyphicon-saved" value="simpan" ></span> Simpan</button>
          <a href="<?php echo base_url('admin/alternatif') ?>" type="kembali" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
        </form>

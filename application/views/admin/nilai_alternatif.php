...
<div id="wrapper">
  ...
  <div id="content-wrapper">
   ...
   <a class="btn btn-success" href="<?php echo site_url('admin/nilai_alternatif/tambah') ?>"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
  ...
  <table class="table table-bordered">
    ...
    <tbody class="css-serial">
      ...
      <tr>
        ...
        <td>
          <a title="Ubah" href="<?php echo site_url('admin/Nilai_alternatif/edit/'.$value['id_nilai_alternatif']) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
        </td>
      </tr>
    <? endforeach ?>
    </tbody>

  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <form action="<?php echo site_url('admin/nilai_alternatif/tambah') ?>" method="post">
            ...
            <a href="<?php echo base_url('admin/nilai_alternatif') ?>" type="kembali" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
        </form>

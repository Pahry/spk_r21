			...
			<div class="container-fluid">
				...
				<form method="post">
					<div class="form-group">
						...
						<a type="tambah" class="btn btn-success" href="<?php echo site_url('admin/crips/add') ?>"> 
					...
					<tbody class="css-serial">
						<?php foreach ($crips as $key => $value): ?>
							<tr class="hidden letak <?php echo $value['id_kriteria'] ?>">
								...
								<td>
									<a class="btn btn-primary" title="Ubah" href="<?php echo site_url('admin/crips/ubah/'. $value['id_crips']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
									<a class="btn btn-danger" title="Hapus" href="<?php echo site_url('admin/crips/hapus/'.$value['id_crips']) ?>" onclick="return confirm('Apakah Anda Yakin ?')"><span class="glyphicon glyphicon-trash"></span></a>
								</td>
							</tr>
